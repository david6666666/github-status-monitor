...
Generated on: 2026-01-20 08:47:29 UTC
...
**总代码变更统计**: +112,264 行添加, -28,528 行删除

### 👤 WeiQing Chen (@david6666666) - 总贡献: 37
**代码变更**: +9,203 行添加, -645 行删除

**Pull Requests (1 open, 36 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Model] support Ltx2 text-to-video image-to-video](https://github.com/vllm-project/vllm-omni/pull/841) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-19 | - | 3,525 | 76 |
...
| **Total for WeiQing Chen** | | | | - | **9,203** | **645** |
...
**代码变更**: +26,440 行添加, -7,185 行删除

**Pull Requests (2 open, 20 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [Dev/rebase 0.14.0](https://github.com/vllm-project/vllm-omni/pull/847) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-19 | - | 3,299 | 880 |
...
| **Total for Zhou Taichang** | | | | - | **26,440** | **7,185** |
...
### 👤 amy-why-3459 - 总贡献: 2
**代码变更**: +1,511 行添加, -423 行删除

**Pull Requests (1 open, 1 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[WIP]Support async computation and communication across stages by chunks](https://github.com/vllm-project/vllm-omni/pull/727) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-10 | - | 1,438 | 412 |
...
| **Total for amy-why-3459** | | | | - | **1,511** | **423** |
...
| Feature | [[WIP]Support async computation and communication across stages by chunks](https://github.com/vllm-project/vllm-omni/pull/727) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `amy-why-3459` | `open` | 2026-01-10 | - | 1,438 | 412 |
...
| Feature | [[Model] support Ltx2 text-to-video image-to-video](https://github.com/vllm-project/vllm-omni/pull/841) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `david6666666` | `open` | 2026-01-19 | - | 3,525 | 76 |
...
| Other | [Dev/rebase 0.14.0](https://github.com/vllm-project/vllm-omni/pull/847) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `tzhouam` | `open` | 2026-01-19 | - | 3,299 | 880 |
