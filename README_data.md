...
Generated on: 2026-02-24 18:26:19 UTC
...
**总代码变更统计**: +176,251 行添加, -40,459 行删除
...
### 👤 Zhou Taichang (@tzhouam) - 总贡献: 35
**代码变更**: +29,222 行添加, -9,519 行删除
...
| **Total for Zhou Taichang** | | | | - | **29,222** | **9,519** |
...
**代码变更**: +8,582 行添加, -2,530 行删除

**Pull Requests (2 open, 17 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Test] Recover Qwen3-omni test cases in test-ready and fix modify stage config](https://github.com/vllm-project/vllm-omni/pull/1449) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-02-24 | - | 85 | 77 |
...
| **Total for wangyu** | | | | - | **8,582** | **2,530** |

### 👤 dengyunyang (@Bounty-hunter) - 总贡献: 16
**代码变更**: +5,804 行添加, -2,025 行删除

**Pull Requests (3 open, 13 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[WIP][FEATURE] Tile/Patch parallelism refactor for easily support other models](https://github.com/vllm-project/vllm-omni/pull/1366) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-02-13 | - | 494 | 8 |
...
| **Total for dengyunyang** | | | | - | **5,804** | **2,025** |
...
**代码变更**: +4,436 行添加, -1,066 行删除

**Pull Requests (3 open, 7 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Bugfix] Race condition in MultiprocExecutor when concurent access to Scheduler](https://github.com/vllm-project/vllm-omni/pull/1448) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-02-24 | - | 527 | 53 |
...
| **Total for knlnguyen1802** | | | | - | **4,436** | **1,066** |

### 👤 Zeyu Huang | 黃澤宇 (@fhfuih) - 总贡献: 10
**代码变更**: +7,254 行添加, -2,403 行删除

**Pull Requests (3 open, 7 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[chore] ComfyUI test and code cleaning](https://github.com/vllm-project/vllm-omni/pull/1435) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-02-23 | - | 1,293 | 105 |
...
| **Total for Zeyu Huang | 黃澤宇** | | | | - | **7,254** | **2,403** |
...
### 👤 amy-why-3459 - 总贡献: 9
**代码变更**: +1,723 行添加, -796 行删除

**Pull Requests (1 open, 8 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Performance]Qwen3-Omni performance optimization](https://github.com/vllm-project/vllm-omni/pull/1378) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-02-14 | - | 96 | 112 |
...
| **Total for amy-why-3459** | | | | - | **1,723** | **796** |
...
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [Add support for gpu_memory_utilization in vllm-deploy-simple; add vll…](https://github.com/vllm-project/vllm-skills/pull/11) | [vllm-project/vllm-skills](https://github.com/vllm-project/vllm-skills) | `open` | 2026-02-23 | - | 239 | 19 |
...
| Feature | [Add support for gpu_memory_utilization in vllm-deploy-simple; add vll…](https://github.com/vllm-project/vllm-skills/pull/11) | [vllm-project/vllm-skills](https://github.com/vllm-project/vllm-skills) | `cyr20040123` | `open` | 2026-02-23 | - | 239 | 19 |
...
| Performance | [[Performance]Qwen3-Omni performance optimization](https://github.com/vllm-project/vllm-omni/pull/1378) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `amy-why-3459` | `open` | 2026-02-14 | - | 96 | 112 |
...
| Bugfix | [[Bugfix] Race condition in MultiprocExecutor when concurent access to Scheduler](https://github.com/vllm-project/vllm-omni/pull/1448) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `knlnguyen1802` | `open` | 2026-02-24 | - | 527 | 53 |
| Bugfix | [[Test] Recover Qwen3-omni test cases in test-ready and fix modify stage config](https://github.com/vllm-project/vllm-omni/pull/1449) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `yenuo26` | `open` | 2026-02-24 | - | 85 | 77 |
...
| Refactor | [[WIP][FEATURE] Tile/Patch parallelism refactor for easily support other models](https://github.com/vllm-project/vllm-omni/pull/1366) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `Bounty-hunter` | `open` | 2026-02-13 | - | 494 | 8 |
