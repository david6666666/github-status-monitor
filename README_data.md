...
Generated on: 2025-08-20 10:16:06 UTC
...
**总代码变更统计**: +9,819 行添加, -606 行删除

### 👤 WeiQing Chen (@david6666666) - 总贡献: 19
**代码变更**: +1,442 行添加, -229 行删除

**Pull Requests (5 open, 6 merged)**
| Title | Repository | State | Created | Additions | Deletions |
| ----- | ---------- | ----- | ------- | --------- | --------- |
| [[Model] Support dp on ViT on GLM-4.5V](https://github.com/vllm-project/vllm/pull/23168) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-08-19 | 92 | 41 |
...
| **Total for WeiQing Chen** | | | | **1,442** | **229** |
...
**代码变更**: +3,302 行添加, -227 行删除

**Pull Requests (2 open, 1 merged)**
| Title | Repository | State | Created | Additions | Deletions |
| ----- | ---------- | ----- | ------- | --------- | --------- |
| [[Feature] Support Encoder MM Cache: switch cache key from (req_id, input_id) to mm_hash](https://github.com/vllm-project/vllm/pull/22711) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-08-12 | 349 | 188 |
...
| **Total for Chenguang Zheng** | | | | **3,302** | **227** |
...
| Title | Repository | State | Created | Additions | Deletions |
| ----- | ---------- | ----- | ------- | --------- | --------- |
| [[BugFix] pp cannot run successfully under NixlConnector](https://github.com/vllm-project/vllm/pull/22976) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-08-15 | 22 | 9 |
| **Total for R2-Y** | | | | **22** | **9** |
