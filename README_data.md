...
Generated on: 2026-01-15 14:01:51 UTC
...
**总代码变更统计**: +95,725 行添加, -25,100 行删除

### 👤 WeiQing Chen (@david6666666) - 总贡献: 35
**代码变更**: +3,968 行添加, -569 行删除

**Pull Requests (1 open, 34 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Misc] add wechat group and star history on README](https://github.com/vllm-project/vllm-omni/pull/801) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-15 | - | 5 | 1 |
...
| **Total for WeiQing Chen** | | | | - | **3,968** | **569** |

### 👤 Samit (@SamitHuang) - 总贡献: 30
**代码变更**: +9,576 行添加, -1,584 行删除
...
### 👤 Zhou Taichang (@tzhouam) - 总贡献: 21
**代码变更**: +16,659 行添加, -5,117 行删除

**Pull Requests (2 open, 19 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[FEATURE] Add support for capturing hidden states in Qwen3MoeLLMModel…](https://github.com/vllm-project/vllm/pull/32387) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2026-01-15 | - | 30 | 3 |
...
| **Total for Zhou Taichang** | | | | - | **16,659** | **5,117** |
...
### 👤 amy-why-3459 - 总贡献: 2
**代码变更**: +1,407 行添加, -407 行删除

**Pull Requests (1 open, 1 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[WIP]Support async computation and communication across stages by chunks](https://github.com/vllm-project/vllm-omni/pull/727) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-10 | - | 1,334 | 396 |
...
| **Total for amy-why-3459** | | | | - | **1,407** | **407** |
...
| Feature | [[WIP]Support async computation and communication across stages by chunks](https://github.com/vllm-project/vllm-omni/pull/727) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `amy-why-3459` | `open` | 2026-01-10 | - | 1,334 | 396 |
...
| Feature | [[FEATURE] Add support for capturing hidden states in Qwen3MoeLLMModel…](https://github.com/vllm-project/vllm/pull/32387) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `tzhouam` | `open` | 2026-01-15 | - | 30 | 3 |
| Feature | [[Misc] add wechat group and star history on README](https://github.com/vllm-project/vllm-omni/pull/801) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `david6666666` | `open` | 2026-01-15 | - | 5 | 1 |
