...
Generated on: 2026-01-26 09:55:05 UTC
...
**总代码变更统计**: +124,469 行添加, -29,330 行删除

### 👤 WeiQing Chen (@david6666666) - 总贡献: 40
**代码变更**: +9,618 行添加, -648 行删除
...
| [[Model] support Ltx2 text-to-video image-to-video](https://github.com/vllm-project/vllm-omni/pull/841) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-19 | - | 3,419 | 79 |
...
| **Total for WeiQing Chen** | | | | - | **9,618** | **648** |
...
**代码变更**: +1,902 行添加, -1,307 行删除

**Pull Requests (3 open, 5 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Feature] Opt metrics structure](https://github.com/vllm-project/vllm-omni/pull/891) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-22 | - | 990 | 631 |
...
| **Total for Junhong Liu** | | | | - | **1,902** | **1,307** |

### 👤 rein yang (@R2-Y) - 总贡献: 8
**代码变更**: +10,292 行添加, -560 行删除

**Pull Requests (2 open, 6 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[WIP] [Doc] add design docs for async chunk in qwen3-omni](https://github.com/vllm-project/vllm-omni/pull/962) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-26 | - | 339 | 0 |
...
| **Total for rein yang** | | | | - | **10,292** | **560** |
...
| Feature | [[Model] support Ltx2 text-to-video image-to-video](https://github.com/vllm-project/vllm-omni/pull/841) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `david6666666` | `open` | 2026-01-19 | - | 3,419 | 79 |
...
| Feature | [[Feature] Opt metrics structure](https://github.com/vllm-project/vllm-omni/pull/891) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `LJH-LBJ` | `open` | 2026-01-22 | - | 990 | 631 |
...
| Docs | [[WIP] [Doc] add design docs for async chunk in qwen3-omni](https://github.com/vllm-project/vllm-omni/pull/962) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `R2-Y` | `open` | 2026-01-26 | - | 339 | 0 |
