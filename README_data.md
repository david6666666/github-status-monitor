...
Generated on: 2025-12-02 10:17:32 UTC
...
### 👤 Gao Han (@Gaohan123) - 总贡献: 15
**代码变更**: +11,670 行添加, -8,341 行删除
...
| **Total for Gao Han** | | | | - | **11,670** | **8,341** |
...
### 👤 Samit (@SamitHuang) - 总贡献: 14
**代码变更**: +3,687 行添加, -321 行删除

**Pull Requests (1 open, 13 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Misc] Qwen-Omni support offline inference with local files](https://github.com/vllm-project/vllm-omni/pull/167) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-02 | - | 365 | 25 |
...
**代码变更**: +10,402 行添加, -1,904 行删除

**Pull Requests (2 open, 10 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Engine] Remove Diffusion_XX which duplicates with Generation_XX](https://github.com/vllm-project/vllm-omni/pull/163) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-02 | - | 16 | 991 |
...
| **Total for Zhou Taichang** | | | | - | **10,402** | **1,904** |

### 👤 Alicia (@congw729) - 总贡献: 7
**代码变更**: +141 行添加, -128 行删除

**Pull Requests (1 open, 6 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Doc] Add installation part for pre built docker.](https://github.com/vllm-project/vllm-omni/pull/141) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-01 | - | 23 | 1 |
...
**代码变更**: +3,969 行添加, -71 行删除

**Pull Requests (2 open, 0 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[WIP] OmniConnector for Multimodal Full Disaggregation](https://github.com/vllm-project/vllm-omni/pull/79) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-11-21 | - | 2,727 | 68 |
...
### 👤 rein yang (@R2-Y) - 总贡献: 1
**代码变更**: +8,063 行添加, -477 行删除
...
### 👤 jiangkuaixue123 - 总贡献: 1
**代码变更**: +2,129 行添加, -61 行删除

**Pull Requests (1 open, 0 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Feature] AFD basic implemetation ](https://github.com/vllm-project/vllm/pull/29772) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-12-01 | - | 2,129 | 61 |
| **Total for jiangkuaixue123** | | | | - | **2,129** | **61** |
...
| Feature | [[Feature] AFD basic implemetation ](https://github.com/vllm-project/vllm/pull/29772) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `jiangkuaixue123` | `open` | 2025-12-01 | - | 2,129 | 61 |
| Feature | [[Misc] Qwen-Omni support offline inference with local files](https://github.com/vllm-project/vllm-omni/pull/167) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `SamitHuang` | `open` | 2025-12-02 | - | 365 | 25 |
...
| Docs | [[Doc] Add installation part for pre built docker.](https://github.com/vllm-project/vllm-omni/pull/141) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `congw729` | `open` | 2025-12-01 | - | 23 | 1 |
...
| Other | [[Engine] Remove Diffusion_XX which duplicates with Generation_XX](https://github.com/vllm-project/vllm-omni/pull/163) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `tzhouam` | `open` | 2025-12-02 | - | 16 | 991 |
