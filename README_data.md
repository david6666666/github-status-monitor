...
Generated on: 2025-10-22 02:28:12 UTC
...
**代码变更**: +4,086 行添加, -224 行删除

**Pull Requests (1 open, 2 merged)**
| Title | Repository | State | Created | Additions | Deletions |
| ----- | ---------- | ----- | ------- | --------- | --------- |
| [[Core] Encoder separation for Encode-Prefill-Decode Disaggregation](https://github.com/vllm-project/vllm/pull/25233) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-09-19 | 3,476 | 57 |
...
| **Total for Chenguang Zheng** | | | | **4,086** | **224** |
