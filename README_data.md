...
Generated on: 2025-12-23 14:18:19 UTC
...
**总代码变更统计**: +85,320 行添加, -20,998 行删除

### 👤 WeiQing Chen (@david6666666) - 总贡献: 29
**代码变更**: +5,851 行添加, -494 行删除
...
| **Total for WeiQing Chen** | | | | - | **5,851** | **494** |

### 👤 Samit (@SamitHuang) - 总贡献: 24
**代码变更**: +8,468 行添加, -1,478 行删除

**Pull Requests (2 open, 22 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Misc] Add Qwen-Image-Edit-2511 running script](https://github.com/vllm-project/vllm-omni/pull/440) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-23 | - | 8 | 0 |
...
| **Total for Samit** | | | | - | **8,468** | **1,478** |

### 👤 Gao Han (@Gaohan123) - 总贡献: 21
**代码变更**: +13,253 行添加, -8,657 行删除

**Pull Requests (1 open, 20 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Feature][WIP] Basic version of supporting streaming output](https://github.com/vllm-project/vllm-omni/pull/367) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-18 | - | 991 | 183 |
...
| **Total for Gao Han** | | | | - | **13,253** | **8,657** |
...
### 👤 Alicia (@congw729) - 总贡献: 14
**代码变更**: +603 行添加, -361 行删除
...
**代码变更**: +10,513 行添加, -1,367 行删除

**Pull Requests (1 open, 8 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[WIP][Core] Supports stage abstraction in the diffusion model](https://github.com/vllm-project/vllm-omni/pull/391) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-20 | - | 1,979 | 1,114 |
...
| **Total for Chenguang Zheng** | | | | - | **10,513** | **1,367** |

### 👤 knlnguyen1802 - 总贡献: 6
**代码变更**: +1,405 行添加, -153 行删除
...
| [RPC support for OmniDiffusion](https://github.com/vllm-project/vllm-omni/pull/371) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-19 | - | 216 | 34 |
...
| **Total for knlnguyen1802** | | | | - | **1,405** | **153** |

### 👤 rein yang (@R2-Y) - 总贡献: 5
**代码变更**: +9,853 行添加, -525 行删除

**Pull Requests (1 open, 4 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Docs] how to add a new multi stage model document](https://github.com/vllm-project/vllm-omni/pull/417) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-23 | - | 652 | 1 |
...
| **Total for rein yang** | | | | - | **9,853** | **525** |

### 👤 dengyunyang (@Bounty-hunter) - 总贡献: 4
**代码变更**: +2,497 行添加, -135 行删除
...
| **Total for dengyunyang** | | | | - | **2,497** | **135** |
...
| [[Feature] AFD basic implemetation ](https://github.com/vllm-project/vllm/pull/29772) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-12-01 | - | 2,645 | 118 |
| **Total for jiangkuaixue123** | | | | - | **2,778** | **191** |
...
| Feature | [[Feature] AFD basic implemetation ](https://github.com/vllm-project/vllm/pull/29772) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `jiangkuaixue123` | `open` | 2025-12-01 | - | 2,645 | 118 |
...
| Feature | [[Feature][WIP] Basic version of supporting streaming output](https://github.com/vllm-project/vllm-omni/pull/367) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `Gaohan123` | `open` | 2025-12-18 | - | 991 | 183 |
| Feature | [RPC support for OmniDiffusion](https://github.com/vllm-project/vllm-omni/pull/371) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `knlnguyen1802` | `open` | 2025-12-19 | - | 216 | 34 |
...
| Feature | [[WIP][Core] Supports stage abstraction in the diffusion model](https://github.com/vllm-project/vllm-omni/pull/391) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `fake0fan` | `open` | 2025-12-20 | - | 1,979 | 1,114 |
...
| Feature | [[Misc] Add Qwen-Image-Edit-2511 running script](https://github.com/vllm-project/vllm-omni/pull/440) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `SamitHuang` | `open` | 2025-12-23 | - | 8 | 0 |
...
| Performance | [[WIP][Benchmark] DiT models Performance benchmark(T2I/I2I/T2V/TI2V)](https://github.com/vllm-project/vllm-omni/pull/362) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `david6666666` | `open` | 2025-12-18 | - | 2,364 | 0 |
...
| Docs | [[Docs] how to add a new multi stage model document](https://github.com/vllm-project/vllm-omni/pull/417) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `R2-Y` | `open` | 2025-12-23 | - | 652 | 1 |
