...
Generated on: 2025-12-25 14:18:28 UTC
...
**总代码变更统计**: +84,672 行添加, -21,894 行删除

### 👤 WeiQing Chen (@david6666666) - 总贡献: 29
**代码变更**: +4,146 行添加, -494 行删除
...
| [[Benchmark] DiT models Performance benchmark(T2I/I2I/T2V/TI2V)](https://github.com/vllm-project/vllm-omni/pull/362) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-18 | - | 659 | 0 |
...
| **Total for WeiQing Chen** | | | | - | **4,146** | **494** |
...
| [[Docs] Fix get started and installation docs](https://github.com/vllm-project/vllm-omni/pull/428) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-23 | - | 7 | 2 |
...
### 👤 Alicia (@congw729) - 总贡献: 15
**代码变更**: +624 行添加, -367 行删除
...
| **Total for Alicia** | | | | - | **624** | **367** |

### 👤 Zhou Taichang (@tzhouam) - 总贡献: 15
**代码变更**: +13,049 行添加, -4,443 行删除

**Pull Requests (2 open, 13 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[WIP] Dev/debug qwen3 mix modality](https://github.com/vllm-project/vllm-omni/pull/431) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-23 | - | 30 | 3 |
| [[Feature] Control the stage init timeout threshold by --stage-init-timeout](https://github.com/vllm-project/vllm-omni/pull/393) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-20 | - | 66 | 58 |
...
**代码变更**: +909 行添加, -413 行删除

**Pull Requests (5 open, 8 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Perf] Optimise tensor concat perf in output processor](https://github.com/vllm-project/vllm-omni/pull/467) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-25 | - | 47 | 22 |
...
| **Total for wuhang** | | | | - | **909** | **413** |

### 👤 Chenguang Zheng (@fake0fan) - 总贡献: 9
**代码变更**: +11,003 行添加, -1,546 行删除

**Pull Requests (1 open, 8 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Core] Supports stage abstraction in the diffusion model](https://github.com/vllm-project/vllm-omni/pull/391) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-20 | - | 2,469 | 1,293 |
...
| **Total for Chenguang Zheng** | | | | - | **11,003** | **1,546** |

### 👤 knlnguyen1802 - 总贡献: 6
**代码变更**: +1,357 行添加, -150 行删除
...
| [RPC support for OmniDiffusion](https://github.com/vllm-project/vllm-omni/pull/371) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-19 | - | 168 | 31 |
...
| **Total for knlnguyen1802** | | | | - | **1,357** | **150** |
...
### 👤 dengyunyang (@Bounty-hunter) - 总贡献: 5
**代码变更**: +2,807 行添加, -780 行删除

**Pull Requests (1 open, 4 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Feature] logger refactor](https://github.com/vllm-project/vllm-omni/pull/466) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-25 | - | 310 | 645 |
...
| **Total for dengyunyang** | | | | - | **2,807** | **780** |

### 👤 Junhong Liu (@LJH-LBJ) - 总贡献: 3
**代码变更**: +169 行添加, -6 行删除

**Pull Requests (1 open, 2 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[BugFix] initial sampling_params_list  when offline inference](https://github.com/vllm-project/vllm-omni/pull/468) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-25 | - | 13 | 0 |
...
| **Total for Junhong Liu** | | | | - | **169** | **6** |

### 👤 NATURE (@natureofnature) - 总贡献: 2
**代码变更**: +3,904 行添加, -193 行删除
...
| **Total for jiangkuaixue123** | | | | - | **2,747** | **191** |
...
| Feature | [RPC support for OmniDiffusion](https://github.com/vllm-project/vllm-omni/pull/371) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `knlnguyen1802` | `open` | 2025-12-19 | - | 168 | 31 |
...
| Feature | [[Core] Supports stage abstraction in the diffusion model](https://github.com/vllm-project/vllm-omni/pull/391) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `fake0fan` | `open` | 2025-12-20 | - | 2,469 | 1,293 |
| Feature | [[Feature] Control the stage init timeout threshold by --stage-init-timeout](https://github.com/vllm-project/vllm-omni/pull/393) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `tzhouam` | `open` | 2025-12-20 | - | 66 | 58 |
| Feature | [[WIP] [Entrypoints] add video online serving](https://github.com/vllm-project/vllm-omni/pull/437) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `david6666666` | `open` | 2025-12-23 | - | 539 | 21 |
...
| Performance | [[Benchmark] DiT models Performance benchmark(T2I/I2I/T2V/TI2V)](https://github.com/vllm-project/vllm-omni/pull/362) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `david6666666` | `open` | 2025-12-18 | - | 659 | 0 |
| Performance | [[Perf] Optimise tensor concat perf in output processor](https://github.com/vllm-project/vllm-omni/pull/467) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `wuhang2014` | `open` | 2025-12-25 | - | 47 | 22 |
...
| Bugfix | [[Docs] Fix get started and installation docs](https://github.com/vllm-project/vllm-omni/pull/428) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `SamitHuang` | `open` | 2025-12-23 | - | 7 | 2 |
...
| Bugfix | [[BugFix] initial sampling_params_list  when offline inference](https://github.com/vllm-project/vllm-omni/pull/468) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `LJH-LBJ` | `open` | 2025-12-25 | - | 13 | 0 |
...
| Other | [[WIP] Dev/debug qwen3 mix modality](https://github.com/vllm-project/vllm-omni/pull/431) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `tzhouam` | `open` | 2025-12-23 | - | 30 | 3 |
...
| Refactor | [[Feature] logger refactor](https://github.com/vllm-project/vllm-omni/pull/466) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `Bounty-hunter` | `open` | 2025-12-25 | - | 310 | 645 |
