...
Generated on: 2026-01-14 11:38:40 UTC
...
**代码变更**: +9,578 行添加, -1,586 行删除

**Pull Requests (2 open, 29 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Bugfix] Fix generation artifacts of Qwen-Image-Edit-2511 and update pipeline DiT param parsing ](https://github.com/vllm-project/vllm-omni/pull/776) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-14 | - | 89 | 23 |
...
### 👤 Zhou Taichang (@tzhouam) - 总贡献: 20
**代码变更**: +16,622 行添加, -5,113 行删除

**Pull Requests (2 open, 18 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Rebase] Partial Rebase to v0.14.0 (Support AR Offiline) and add GLM-Image](https://github.com/vllm-project/vllm-omni/pull/763) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-13 | - | 2,694 | 508 |
...
| **Total for Zhou Taichang** | | | | - | **16,622** | **5,113** |

### 👤 Alicia (@congw729) - 总贡献: 17
**代码变更**: +2,070 行添加, -436 行删除

**Pull Requests (2 open, 15 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[CI] Add pytest markers in config files.](https://github.com/vllm-project/vllm-omni/pull/719) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-09 | - | 580 | 17 |
...
| **Total for Alicia** | | | | - | **2,070** | **436** |

### 👤 wuhang (@wuhang2014) - 总贡献: 12
**代码变更**: +923 行添加, -396 行删除
...
| **Total for wuhang** | | | | - | **923** | **396** |

### 👤 Chenguang Zheng (@fake0fan) - 总贡献: 11
**代码变更**: +11,035 行添加, -1,573 行删除
...
| **Total for Chenguang Zheng** | | | | - | **11,035** | **1,573** |

### 👤 knlnguyen1802 - 总贡献: 9
**代码变更**: +2,818 行添加, -951 行删除
...
| **Total for knlnguyen1802** | | | | - | **2,818** | **951** |

### 👤 dengyunyang (@Bounty-hunter) - 总贡献: 8
**代码变更**: +3,004 行添加, -787 行删除
...
| **Total for dengyunyang** | | | | - | **3,004** | **787** |
...
| **Total for rein yang** | | | | - | **9,855** | **527** |

### 👤 NATURE (@natureofnature) - 总贡献: 3
**代码变更**: +4,058 行添加, -204 行删除

**Pull Requests (2 open, 1 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[WIP]Multi-Stage Device Auto Allocation](https://github.com/vllm-project/vllm-omni/pull/775) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-14 | - | 154 | 11 |
...
| **Total for NATURE** | | | | - | **4,058** | **204** |

### 👤 jiangkuaixue123 - 总贡献: 3
**代码变更**: +2,749 行添加, -193 行删除
...
| [[Feature] AFD basic implemetation ](https://github.com/vllm-project/vllm/pull/29772) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-12-01 | - | 2,614 | 118 |
| **Total for jiangkuaixue123** | | | | - | **2,749** | **193** |
...
### 👤 amy-why-3459 - 总贡献: 2
**代码变更**: +843 行添加, -380 行删除

**Pull Requests (1 open, 1 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[WIP]Support async computation and communication across stages by chunks](https://github.com/vllm-project/vllm-omni/pull/727) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2026-01-10 | - | 770 | 369 |
...
| **Total for amy-why-3459** | | | | - | **843** | **380** |
...
| Feature | [[Feature] AFD basic implemetation ](https://github.com/vllm-project/vllm/pull/29772) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `jiangkuaixue123` | `open` | 2025-12-01 | - | 2,614 | 118 |
...
| Feature | [[WIP]Support async computation and communication across stages by chunks](https://github.com/vllm-project/vllm-omni/pull/727) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `amy-why-3459` | `open` | 2026-01-10 | - | 770 | 369 |
...
| Feature | [[Rebase] Partial Rebase to v0.14.0 (Support AR Offiline) and add GLM-Image](https://github.com/vllm-project/vllm-omni/pull/763) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `tzhouam` | `open` | 2026-01-13 | - | 2,694 | 508 |
...
| Bugfix | [[Bugfix] Fix generation artifacts of Qwen-Image-Edit-2511 and update pipeline DiT param parsing ](https://github.com/vllm-project/vllm-omni/pull/776) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `SamitHuang` | `open` | 2026-01-14 | - | 89 | 23 |
...
| Other | [[WIP]Multi-Stage Device Auto Allocation](https://github.com/vllm-project/vllm-omni/pull/775) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `natureofnature` | `open` | 2026-01-14 | - | 154 | 11 |
...
| Test | [[CI] Add pytest markers in config files.](https://github.com/vllm-project/vllm-omni/pull/719) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `congw729` | `open` | 2026-01-09 | - | 580 | 17 |
