...
Generated on: 2025-08-22 02:27:40 UTC
...
| **Total for WeiQing Chen** | | | | **1,544** | **259** |
...
**代码变更**: +3,229 行添加, -188 行删除

**Pull Requests (2 open, 1 merged)**
| Title | Repository | State | Created | Additions | Deletions |
| ----- | ---------- | ----- | ------- | --------- | --------- |
| [[Feature] Support Encoder MM Cache: switch cache key from (req_id, input_id) to mm_hash](https://github.com/vllm-project/vllm/pull/22711) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-08-12 | 319 | 156 |
...
| **Total for Chenguang Zheng** | | | | **3,229** | **188** |
