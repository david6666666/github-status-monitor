...
Generated on: 2025-08-21 05:13:25 UTC
...
**代码变更**: +3,280 行添加, -204 行删除

**Pull Requests (2 open, 1 merged)**
| Title | Repository | State | Created | Additions | Deletions |
| ----- | ---------- | ----- | ------- | --------- | --------- |
| [[Feature] Support Encoder MM Cache: switch cache key from (req_id, input_id) to mm_hash](https://github.com/vllm-project/vllm/pull/22711) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-08-12 | 327 | 165 |
...
| **Total for Chenguang Zheng** | | | | **3,280** | **204** |
