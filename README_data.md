...
Generated on: 2025-12-04 11:15:40 UTC
...
### 👤 Gao Han (@Gaohan123) - 总贡献: 16
**代码变更**: +11,750 行添加, -8,343 行删除
...
| **Total for Gao Han** | | | | - | **11,750** | **8,343** |

### 👤 Samit (@SamitHuang) - 总贡献: 15
**代码变更**: +4,689 行添加, -321 行删除

**Pull Requests (1 open, 14 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Model][WIP] Add Qwen-Image-Edit](https://github.com/vllm-project/vllm-omni/pull/196) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-04 | - | 1,002 | 0 |
...
**代码变更**: +10,401 行添加, -1,905 行删除

**Pull Requests (2 open, 10 merged)**
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[Engine] Remove Diffusion_XX which duplicates with Generation_XX](https://github.com/vllm-project/vllm-omni/pull/163) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-02 | - | 15 | 992 |
...
| **Total for Zhou Taichang** | | | | - | **10,401** | **1,905** |
...
| Title | Repository | State | Created | Merged | Additions | Deletions |
| ----- | ---------- | ----- | ------- | ------ | --------- | --------- |
| [[bugfix] qwen2.5 omni does not support chunked prefill now](https://github.com/vllm-project/vllm-omni/pull/193) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `open` | 2025-12-04 | - | 3 | 0 |
...
| **Total for jiangkuaixue123** | | | | - | **2,100** | **60** |
...
| Feature | [[Model][WIP] Add Qwen-Image-Edit](https://github.com/vllm-project/vllm-omni/pull/196) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `SamitHuang` | `open` | 2025-12-04 | - | 1,002 | 0 |
...
| Bugfix | [[bugfix] qwen2.5 omni does not support chunked prefill now](https://github.com/vllm-project/vllm-omni/pull/193) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `fake0fan` | `open` | 2025-12-04 | - | 3 | 0 |
...
| Other | [[Engine] Remove Diffusion_XX which duplicates with Generation_XX](https://github.com/vllm-project/vllm-omni/pull/163) | [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) | `tzhouam` | `open` | 2025-12-02 | - | 15 | 992 |
