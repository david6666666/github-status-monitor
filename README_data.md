...
Generated on: 2025-08-23 07:11:14 UTC
...
**代码变更**: +3,254 行添加, -182 行删除

**Pull Requests (2 open, 1 merged)**
| Title | Repository | State | Created | Additions | Deletions |
| ----- | ---------- | ----- | ------- | --------- | --------- |
| [[Core][Multimodal] Track encode cache entries by mm_hash and enable embedding sharing between requests](https://github.com/vllm-project/vllm/pull/22711) | [vllm-project/vllm](https://github.com/vllm-project/vllm) | `open` | 2025-08-12 | 345 | 150 |
...
| **Total for Chenguang Zheng** | | | | **3,254** | **182** |
